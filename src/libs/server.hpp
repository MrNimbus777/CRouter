        ...
        boost::asio::async_read_until(socket_, request_buffer_, "\r\n\r\n",
            boost::asio::bind_executor(strand_,
                [this, self](boost::system::error_code ec, std::size_t length) {
                    ...
                    if (!ec) {
                        // Extract content from the streambuf.
                        // Note: request_buffer_.data() returns a mutable_buffers_1 object.
                        // You might need to use boost::beast::buffers_to_string for convenience,
                        // or iterate through the buffers. For simplicity, I'll assume direct access
                        // for now, but be aware of how streambuf works with scattered buffers.
